...
//! manually on aiwonder, then re-runs this test in restore-verify mode against
...
#[test]
#[ignore = "manual aiwonder FSV: seed, restic backup/restore, then verify restored bytes"]
